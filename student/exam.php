...
<html lang="en">
<head>
    <title>Exam - Student Panel</title>
...
<div class="content">
    <h2>Exam for Course ID: <?= $course_id ?></h2>

    <?php if (!isset($_SESSION['quiz_access']) || $_SESSION['quiz_access'] !== true): ?>
        <div class="alert alert-warning">
            You need to pay ₹<?= $price ?> to access this exam.
        </div>
        <button class="btn btn-primary" onclick="payNow()">Pay ₹<?= $price ?> & Start Exam</button>
    ...
    <?php elseif (isset($_SESSION['score'])): ?>
        ...
        <a href="quiz.php?reset=true" class="btn btn-warning">Retake Exam</a>
...
function payNow() {
    var options = {
        ...
        "amount": <?= $price * 100 ?>,
        "currency": "INR",
        "name": "Course Exam Access",
        "description": "Exam Subscription Access",
